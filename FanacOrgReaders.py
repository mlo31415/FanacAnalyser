...
def ReadFanacFanzineIndexPageNew(fanzineName: str, directoryUrl: str, html: str) -> list[FanzineIssueInfo]:
    ...
    # if m is None:
    #     assert False
    fiiList=ExtractFanzineIndexTableInfoOld(directoryUrl, html, editors, country, fztype, alphabetizeIndividually=True, useNewTableStructure=True)
...
def ReadFanacFanzineIndexPageOld(fanzineName: str, directoryUrl: str, html: str) -> list[FanzineIssueInfo]:
    ...
    # Walk the table and extract the fanzines in it
    fiiList=ExtractFanzineIndexTableInfoOld(directoryUrl, html, editors, country, fanzineType, alphabetizeIndividually=True)
...
def ExtractFanzineIndexTableInfoOld(directoryUrl: str, html: str, editor: str, defaultcountry: str, fanzineType: str="",
